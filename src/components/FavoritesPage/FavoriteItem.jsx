...
const FavoriteItem = ({ id, imageUrl, name, price, description }) => {

	const dispatch = useDispatch();
	const [favorite] = useState(useSelector((state) => state.favorite.items.find(item => item.id === id)));
	...
	return (
		<div className={styles.favoriteItem}>
			...
			<div className={styles.info}>
				...
				<div className={cn(styles.favorites, {[styles.favoritesAct]: favorite})} onClick={addProductToFavorite}>
